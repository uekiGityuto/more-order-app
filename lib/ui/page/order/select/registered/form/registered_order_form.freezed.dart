...
part of 'registered_order_form.dart';
...
mixin _$RegisteredOrderForm {
  ...
  @JsonKey(ignore: true)
  $RegisteredOrderFormCopyWith<RegisteredOrderForm> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RegisteredOrderFormCopyWith<$Res> {
  factory $RegisteredOrderFormCopyWith(
          RegisteredOrderForm value, $Res Function(RegisteredOrderForm) then) =
      _$RegisteredOrderFormCopyWithImpl<$Res, RegisteredOrderForm>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RegisteredOrderFormCopyWithImpl<$Res, $Val extends RegisteredOrderForm>
    implements $RegisteredOrderFormCopyWith<$Res> {
  _$RegisteredOrderFormCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RegisteredOrderFormImplCopyWith<$Res>
    implements $RegisteredOrderFormCopyWith<$Res> {
  factory _$$RegisteredOrderFormImplCopyWith(_$RegisteredOrderFormImpl value,
          $Res Function(_$RegisteredOrderFormImpl) then) =
      __$$RegisteredOrderFormImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {FormCreationStatus creationStatus,
...
/// @nodoc
class __$$RegisteredOrderFormImplCopyWithImpl<$Res>
    extends _$RegisteredOrderFormCopyWithImpl<$Res, _$RegisteredOrderFormImpl>
    implements _$$RegisteredOrderFormImplCopyWith<$Res> {
  __$$RegisteredOrderFormImplCopyWithImpl(_$RegisteredOrderFormImpl _value,
      $Res Function(_$RegisteredOrderFormImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RegisteredOrderFormImpl(
      creationStatus: null == creationStatus
          ? _value.creationStatus
          : creationStatus // ignore: cast_nullable_to_non_nullable
              as FormCreationStatus,
...
class _$RegisteredOrderFormImpl implements _RegisteredOrderForm {
  _$RegisteredOrderFormImpl(
  ...
  @override
  String toString() {
    return 'RegisteredOrderForm(creationStatus: $creationStatus, reasons: $reasons, reasonInput: $reasonInput, scene: $scene, phrasesInput: $phrasesInput, paymentMethods: $paymentMethods, paymentMethodInput: $paymentMethodInput)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RegisteredOrderFormImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RegisteredOrderFormImplCopyWith<_$RegisteredOrderFormImpl> get copyWith =>
      __$$RegisteredOrderFormImplCopyWithImpl<_$RegisteredOrderFormImpl>(
          this, _$identity);
}

abstract class _RegisteredOrderForm implements RegisteredOrderForm {
  factory _RegisteredOrderForm(
      ...
      required final Map<Id, int> phrasesInput,
      required final List<PaymentMethod>? paymentMethods,
      required final Id? paymentMethodInput}) = _$RegisteredOrderFormImpl;
