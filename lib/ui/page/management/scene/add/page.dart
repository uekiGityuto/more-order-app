...
import 'package:smart_order_app/ui/page/management/scene/add/form/scene_form_controller.dart';
...
class SceneAddPage extends HookConsumerWidget with ErrorHandlerMixin {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final sceneForm = ref.watch(sceneFormControllerProvider);
          ...
          child: Column(
            children: [
              TextField(
                ...
                onChanged: ref
                    .read(sceneFormControllerProvider.notifier)
                    .onChangeScene,
              ),
              FormErrorMessage(
